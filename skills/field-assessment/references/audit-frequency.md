...
| tier | project scope | current-change scope | current-change 触发 skill |
|---|---|---|---|
| `tier-small` | 每完成 5 个 change | 不要求 | — |
| `tier-medium` | 每完成 3 个 change | 每个关键链任务完成时 | `executing-plans` 步骤 1 |
| `tier-large` | 每周一次 | 每完成 1 个 change | `td-apply` 步骤 6.4 |
